...
class _$_PlaceDto implements _PlaceDto {
  ...
  @override
  String toString() {
    return 'PlaceDto(id: $id, name: $name, lat: $lat, lng: $lng, urls: $urls, placeType: $placeType, description: $description, distance: $distance)';
  }
...
abstract class _PlaceDto implements PlaceDto {
  const factory _PlaceDto(
      ...
      final double? distance}) = _$_PlaceDto;
